...
Client.prototype.addEnvelope = function(envelope) {
  this.envelope = envelope;
};

Client.prototype._startMarketoHeader = function() {
  return '<SOAP-ENV:Header>';
};

Client.prototype._endMarketoHeader = function() {
  return '</SOAP-ENV:Header>';
};

Client.prototype._endMarketoEnvelope = function() {
  return '</SOAP-ENV:Envelope>';
};

Client.prototype._startMarketoAuthHeader = function() {
  return '<tns:AuthenticationHeader>';
};

Client.prototype._endMarketoAuthHeader = function() {
  return '</tns:AuthenticationHeader>';
};

Client.prototype._startMarketoBody = function() {
  return '<SOAP-ENV:Body>';
};

Client.prototype._endMarketoBody = function() {
  return '</SOAP-ENV:Body>';
};
